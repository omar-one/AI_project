...
if __name__ == "__main__":
    ...
    # 2. Phase 1: Clean the entire dataframe
    cleaned_df = preprocessing_phase_1(raw_df)

    # 3. Split the cleaned data
    X_train_raw, X_val_raw, y_train_raw, y_val_raw = split_train_test(cleaned_df)

    # 4. Phase 2: Encode & Scale (Passes 4, returns 4)
    X_train, X_val, y_train, y_val = preprocessing_phase_2(
